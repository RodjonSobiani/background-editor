...
```
cd existing_repo
git remote add origin https://gitlab.ipst-dev.com/background-editor/background-editor-front.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.ipst-dev.com/background-editor/background-editor-front/-/settings/integrations)
...
structure it however you want - this is just a starting point!). Thanks to
